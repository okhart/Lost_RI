...
define config.name = _("Затерянный в Институте")
...
define config.version = "PRE ALPHA"


## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p("""Created by Lost_RI team.""")
...
define config.save_directory = "Lost_RI-1706555454"
